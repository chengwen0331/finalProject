...
import 'package:barterit/billscreen.dart';
...
class _BuyerCartScreenState extends State<BuyerCartScreen> {
  ...
  void loadcart() {
    http.post(Uri.parse("${MyConfig().SERVER}/barterit_application/php/load_cart.php"),
        body: {
  ...
  void deleteCart(int index) {
    http.post(Uri.parse("${MyConfig().SERVER}/barterit_application/php/delete_cart.php"),
        body: {
  ...
  void updateCart(int index, int newqty, double newprice) {
    http.post(Uri.parse("${MyConfig().SERVER}/barterit_application/php/update_cart.php"),
        body: {
          "cartid": cartList[index].cartId,
